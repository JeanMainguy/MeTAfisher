...
def parse_arguments():
    ...
    ta_data_dir = os.path.join(project_dir, "dependence")
    ...
    parser.add_argument("--data_dir",
                        required=True,
                        help="Pathway of the data folder where all the data files are stored : fna_file, faa_file, scaffold_file, gff_file")
    parser.add_argument("--data_name",
                        help="Common name of all data files, the name without the extension.  fna_file, faa_file, scaffold_file, gff_file are different only by their extansions : .fna, .faa, .fasta, .gff respectively")
